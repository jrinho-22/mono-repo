...
export const Login: React.FC = () => {
  ...
  const googleSignIn = async () => {
    ...
    } else dispatch(authActions.login(key));
  };
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Link onClick={switchSignUpPage}>sign up</Link>
      </span>
      <GoogleButton style={{ margin: "4px" }} onClick={googleSignIn}>
        {" "}
        google sigin{" "}
      </GoogleButton>
    </React.Fragment>
...
const SignUp: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        Return to&nbsp; <Link onClick={switchSignInPage}>sign in</Link>{" "}
        &nbsp;page
      </span>
    </React.Fragment>
  );
...
const AuthPage: React.FC = () => {
  ...
  return <Box>{reduxAuth.signUp === false ? <Login /> : <SignUp />}</Box>;
};
